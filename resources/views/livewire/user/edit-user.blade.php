<div class="container mx-auto p-4">
    <form wire:submit.prevent="update" class="space-y-4">
        ...
        <div>
            ...
            <input wire:model="mobile" type="text" class="w-full p-2 rounded dark:bg-gray-800 dark:text-gray-200">
        ...
        <div>
            ...
            <input wire:model="whatsapp" type="text" class="w-full p-2 rounded dark:bg-gray-800 dark:text-gray-200">
